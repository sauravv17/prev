...
public class testHashSetDemo {
	...
	public static void main(String[] args) {
		...
		Book book2 = new Book("JK Rowling", "Harry Potter", 1999);
		Book book3 = new Book("Business at the speed of thought", "Bill Gates", 1997);
		Book book4 = new Book("Effective Java", "Joshua Bloch", 1942);
